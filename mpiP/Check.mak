...
site.exp: ./config.status Makefile
	...
	@echo "set host_cpu aarch64" >> ./tmp0
	@echo "set host_vendor unknown" >> ./tmp0
	@echo "set target_os linux-gnu" >> ./tmp0
	@echo "set target_alias " >> ./tmp0
	@echo "set target_cpu aarch64" >> ./tmp0
	@echo "set target_vendor unknown" >> ./tmp0
	@echo "set host_triplet aarch64-unknown-linux-gnu" >> ./tmp0
	@echo "set target_triplet aarch64-unknown-linux-gnu">>./tmp0
