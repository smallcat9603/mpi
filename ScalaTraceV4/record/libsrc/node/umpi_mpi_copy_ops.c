...
(MPI_Request *) malloc (sizeof(MPI_Request) * op->data.mpi.count);
...
if (op->data.mpi.array_of_starts != NULL) {
newop->data.mpi.array_of_starts =
(int *) malloc (sizeof(int) * op->data.mpi.count);
assert (newop->data.mpi.array_of_starts);
bcopy (op->data.mpi.array_of_starts,
newop->data.mpi.array_of_starts,
sizeof(int) * op->data.mpi.count);
}

return;
} /* umpi_copy_op_MPI_Type_create_subarray */


void
umpi_copy_op_MPI_Type_get_contents(umpi_op_t*op, umpi_op_t*newop)
{
if (op->data.mpi.array_of_integers != NULL) {
newop->data.mpi.array_of_integers =
(int *) malloc (sizeof(int) * op->data.mpi.count);
assert (newop->data.mpi.array_of_integers);
bcopy (op->data.mpi.array_of_integers,
newop->data.mpi.array_of_integers,
sizeof(int) * op->data.mpi.count);
}

if (op->data.mpi.the_addresses != NULL) {
newop->data.mpi.the_addresses =
(MPI_Aint *) malloc (sizeof(MPI_Aint) * op->data.mpi.addrcount);
assert (newop->data.mpi.the_addresses);
bcopy (op->data.mpi.the_addresses,
newop->data.mpi.the_addresses,
sizeof(int) * op->data.mpi.addrcount);
}

if (op->data.mpi.the_datatypes != NULL) {
newop->data.mpi.the_datatypes =
(MPI_Datatype *) malloc (sizeof(MPI_Datatype) * op->data.mpi.dtypecount);
assert (newop->data.mpi.the_datatypes);
bcopy (op->data.mpi.the_datatypes,
newop->data.mpi.the_datatypes,
sizeof(int) * op->data.mpi.dtypecount);
}

return;
} /* umpi_copy_op_MPI_Type_get_contents */
...
void
umpi_copy_op_MPI_Type_indexed(umpi_op_t*op, umpi_op_t*newop)
{
if (op->data.mpi.array_of_blocklens != NULL) {
newop->data.mpi.array_of_blocklens =
(int *) malloc (sizeof(int) * op->data.mpi.count);
assert (newop->data.mpi.array_of_blocklens);
bcopy (op->data.mpi.array_of_blocklens,
newop->data.mpi.array_of_blocklens,
sizeof(int) * op->data.mpi.count);
}

if (op->data.mpi.array_of_int_displacements != NULL) {
newop->data.mpi.array_of_int_displacements =
(int *) malloc (sizeof(int) * op->data.mpi.count);
assert (newop->data.mpi.array_of_int_displacements);
bcopy (op->data.mpi.array_of_int_displacements,
newop->data.mpi.array_of_int_displacements,
sizeof(int) * op->data.mpi.count);
}

return;
} /* umpi_copy_op_MPI_Type_indexed */


void
umpi_copy_op_MPI_Waitall(umpi_op_t*op, umpi_op_t*newop)
{
if (op->data.mpi.array_of_requests != NULL) {
newop->data.mpi.array_of_requests =
(MPI_Request *) malloc (sizeof(MPI_Request) * op->data.mpi.count);
...
return;
} /* umpi_copy_op_MPI_Waitall */


void
umpi_copy_op_MPI_Waitany(umpi_op_t*op, umpi_op_t*newop)
{
if (op->data.mpi.array_of_requests != NULL) {
newop->data.mpi.array_of_requests =
(MPI_Request *) malloc (sizeof(MPI_Request) * op->data.mpi.count);
...
return;
} /* umpi_copy_op_MPI_Waitany */


void
umpi_copy_op_MPI_Waitsome(umpi_op_t*op, umpi_op_t*newop)
{
if (op->data.mpi.array_of_requests != NULL) {
newop->data.mpi.array_of_requests =
(MPI_Request *) malloc (sizeof(MPI_Request) * op->data.mpi.count);
