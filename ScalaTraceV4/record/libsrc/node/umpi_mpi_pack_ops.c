...
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.comm)+sizeof(op->data.mpi.comm);
...
if (temp) {
bcopy (op->data.mpi.array_of_int_displacements, &buf[index], sizeof(op->data.mpi.array_of_int_displacements[0])*temp);
...
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.array_of_blocklens[0]))+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.array_of_int_displacements[0]))+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.newtype);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_Waitany */


int umpi_pack_op_size_MPI_Waitany(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.array_of_requests[0]))+sizeof(op->data.mpi.index)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_Waitany */


int umpi_pack_op_MPI_Waitsome(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_Waitsome(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_Waitsome */


int umpi_pack_op_size_MPI_Waitsome(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.array_of_requests[0]))+sizeof(op->data.mpi.outcount)+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.array_of_indices[0]))+sizeof(op->data.mpi.count)+(op->data.mpi.count*sizeof(op->data.mpi.statuses_srcs[0]));
} /* umpi_pack_op_size_MPI_Waitsome */


int umpi_pack_op_MPI_Wtick(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_Wtick(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_Wtick */


int umpi_pack_op_size_MPI_Wtick(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num);
} /* umpi_pack_op_size_MPI_Wtick */


int umpi_pack_op_MPI_Wtime(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_Wtime(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_Wtime */


int umpi_pack_op_size_MPI_Wtime(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num);
} /* umpi_pack_op_size_MPI_Wtime */


int umpi_pack_op_write(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_write(op);
...
bcopy (&(op->data.mpi.fd), &buf[index], sizeof(op->data.mpi.fd));
...
int umpi_pack_op_size_write(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count);
} /* umpi_pack_op_size_write */


int umpi_pack_op_read(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_read(op);
...
int umpi_pack_op_size_read(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count);
} /* umpi_pack_op_size_read */


int umpi_pack_op_open(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_open(op);
...
bcopy (&(op->data.mpi.filename), &buf[index], sizeof(op->data.mpi.filename));
index += sizeof(op->data.mpi.filename);

bcopy (&(op->data.mpi.flags), &buf[index], sizeof(op->data.mpi.flags));
index += sizeof(op->data.mpi.flags);

bcopy (&(op->data.mpi.mode), &buf[index], sizeof(op->data.mpi.mode));
...
int umpi_pack_op_size_open(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filename)+sizeof(op->data.mpi.flags)+sizeof(op->data.mpi.mode);
} /* umpi_pack_op_size_open */


int umpi_pack_op_open64(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_open64(op);
...
int umpi_pack_op_size_open64(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filename)+sizeof(op->data.mpi.flags)+sizeof(op->data.mpi.mode);
} /* umpi_pack_op_size_open64 */


int umpi_pack_op_creat(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_creat(op);
...
bcopy (&(op->data.mpi.pathname), &buf[index], sizeof(op->data.mpi.pathname));
...
int umpi_pack_op_size_creat(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.pathname)+sizeof(op->data.mpi.mode);
} /* umpi_pack_op_size_creat */


int umpi_pack_op_close(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_close(op);
...
int umpi_pack_op_size_close(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd);
} /* umpi_pack_op_size_close */


int umpi_pack_op_lseek(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_lseek(op);
...
bcopy (&(op->data.mpi.offset), &buf[index], sizeof(op->data.mpi.offset));
index += sizeof(op->data.mpi.offset);

bcopy (&(op->data.mpi.whence), &buf[index], sizeof(op->data.mpi.whence));
...
int umpi_pack_op_size_lseek(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.whence);
} /* umpi_pack_op_size_lseek */


int umpi_pack_op_lseek64(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_lseek64(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_lseek64 */


int umpi_pack_op_size_lseek64(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.whence);
} /* umpi_pack_op_size_lseek64 */


int umpi_pack_op_fcntl(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fcntl(op);
...
bcopy (&(op->data.mpi.cmd), &buf[index], sizeof(op->data.mpi.cmd));
...
int umpi_pack_op_size_fcntl(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fd)+sizeof(op->data.mpi.cmd);
} /* umpi_pack_op_size_fcntl */


int umpi_pack_op_dup(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_dup(op);
...
bcopy (&(op->data.mpi.oldfd), &buf[index], sizeof(op->data.mpi.oldfd));
...
int umpi_pack_op_size_dup(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.oldfd);
} /* umpi_pack_op_size_dup */


int umpi_pack_op_dup2(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_dup2(op);
...
bcopy (&(op->data.mpi.newfd), &buf[index], sizeof(op->data.mpi.newfd));
...
int umpi_pack_op_size_dup2(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.oldfd)+sizeof(op->data.mpi.newfd);
} /* umpi_pack_op_size_dup2 */


int umpi_pack_op_remove(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_remove(op);
...
int umpi_pack_op_size_remove(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filename);
} /* umpi_pack_op_size_remove */


int umpi_pack_op_fopen(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fopen(op);
...
bcopy (&(op->data.mpi.filename1), &buf[index], sizeof(op->data.mpi.filename1));
...
int umpi_pack_op_size_fopen(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filename)+sizeof(op->data.mpi.filename1);
} /* umpi_pack_op_size_fopen */


int umpi_pack_op_fclose(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fclose(op);
...
bcopy (&(op->data.mpi.filestream), &buf[index], sizeof(op->data.mpi.filestream));
...
int umpi_pack_op_size_fclose(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filestream);
} /* umpi_pack_op_size_fclose */


int umpi_pack_op_fread(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fread(op);
...
bcopy (&(op->data.mpi.buffer), &buf[index], sizeof(op->data.mpi.buffer));
...
int umpi_pack_op_size_fread(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.buffer)+sizeof(op->data.mpi.size)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.filestream);
} /* umpi_pack_op_size_fread */


int umpi_pack_op_fwrite(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fwrite(op);
...
int umpi_pack_op_size_fwrite(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.buffer)+sizeof(op->data.mpi.size)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.filestream);
} /* umpi_pack_op_size_fwrite */


int umpi_pack_op_fseek(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_fseek(op);
...
int umpi_pack_op_size_fseek(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filestream)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.whence);
} /* umpi_pack_op_size_fseek */


int umpi_pack_op_MPI_File_open(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_open(op);
...
bcopy (&(op->data.mpi.amode), &buf[index], sizeof(op->data.mpi.amode));
index += sizeof(op->data.mpi.amode);

bcopy (&(op->data.mpi.info), &buf[index], sizeof(op->data.mpi.info));
index += sizeof(op->data.mpi.info);

bcopy (&(op->data.mpi.fh), &buf[index], sizeof(op->data.mpi.fh));
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_open */


int umpi_pack_op_size_MPI_File_open(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.comm)+sizeof(op->data.mpi.filename)+sizeof(op->data.mpi.amode)+sizeof(op->data.mpi.info)+sizeof(op->data.mpi.fh);
} /* umpi_pack_op_size_MPI_File_open */


int umpi_pack_op_MPI_File_set_view(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_set_view(op);
...
bcopy (&(op->data.mpi.disp), &buf[index], sizeof(op->data.mpi.disp));
index += sizeof(op->data.mpi.disp);

bcopy (&(op->data.mpi.etype), &buf[index], sizeof(op->data.mpi.etype));
index += sizeof(op->data.mpi.etype);

bcopy (&(op->data.mpi.filetype), &buf[index], sizeof(op->data.mpi.filetype));
index += sizeof(op->data.mpi.filetype);

bcopy (&(op->data.mpi.datarep), &buf[index], sizeof(op->data.mpi.datarep));
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_set_view */


int umpi_pack_op_size_MPI_File_set_view(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.disp)+sizeof(op->data.mpi.etype)+sizeof(op->data.mpi.filetype)+sizeof(op->data.mpi.datarep)+sizeof(op->data.mpi.info);
} /* umpi_pack_op_size_MPI_File_set_view */


int umpi_pack_op_MPI_File_write_at(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_at(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_at */


int umpi_pack_op_size_MPI_File_write_at(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_at */


int umpi_pack_op_MPI_File_write_all(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_all(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_all */


int umpi_pack_op_size_MPI_File_write_all(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_all */


int umpi_pack_op_MPI_File_write(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write */


int umpi_pack_op_size_MPI_File_write(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write */


int umpi_pack_op_MPI_File_write_at_all(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_at_all(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_at_all */


int umpi_pack_op_size_MPI_File_write_at_all(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_at_all */


int umpi_pack_op_MPI_File_read_all(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_all(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_all */


int umpi_pack_op_size_MPI_File_read_all(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_all */


int umpi_pack_op_MPI_File_read(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read */


int umpi_pack_op_size_MPI_File_read(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read */


int umpi_pack_op_MPI_File_read_at(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_at(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_at */


int umpi_pack_op_size_MPI_File_read_at(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_at */


int umpi_pack_op_MPI_File_read_at_all(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_at_all(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_at_all */


int umpi_pack_op_size_MPI_File_read_at_all(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_at_all */


int umpi_pack_op_MPI_File_seek(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_seek(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_seek */


int umpi_pack_op_size_MPI_File_seek(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.whence);
} /* umpi_pack_op_size_MPI_File_seek */


int umpi_pack_op_MPI_File_seek_shared(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_seek_shared(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_seek_shared */


int umpi_pack_op_size_MPI_File_seek_shared(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.whence);
} /* umpi_pack_op_size_MPI_File_seek_shared */


int umpi_pack_op_MPI_File_close(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_close(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_close */


int umpi_pack_op_size_MPI_File_close(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh);
} /* umpi_pack_op_size_MPI_File_close */


int umpi_pack_op_MPI_File_delete(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_delete(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_delete */


int umpi_pack_op_size_MPI_File_delete(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.filename)+sizeof(op->data.mpi.info);
} /* umpi_pack_op_size_MPI_File_delete */


int umpi_pack_op_MPI_File_set_size(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_set_size(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_set_size */


int umpi_pack_op_size_MPI_File_set_size(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.size);
} /* umpi_pack_op_size_MPI_File_set_size */


int umpi_pack_op_MPI_File_preallocate(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_preallocate(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_preallocate */


int umpi_pack_op_size_MPI_File_preallocate(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.size);
} /* umpi_pack_op_size_MPI_File_preallocate */


int umpi_pack_op_MPI_File_sync(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_sync(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_sync */


int umpi_pack_op_size_MPI_File_sync(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh);
} /* umpi_pack_op_size_MPI_File_sync */


int umpi_pack_op_MPI_File_set_atomicity(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_set_atomicity(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_set_atomicity */


int umpi_pack_op_size_MPI_File_set_atomicity(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.flag);
} /* umpi_pack_op_size_MPI_File_set_atomicity */


int umpi_pack_op_MPI_File_iread(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iread(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iread */


int umpi_pack_op_size_MPI_File_iread(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iread */


int umpi_pack_op_MPI_File_iread_at(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iread_at(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iread_at */


int umpi_pack_op_size_MPI_File_iread_at(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iread_at */


int umpi_pack_op_MPI_File_iwrite(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iwrite(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iwrite */


int umpi_pack_op_size_MPI_File_iwrite(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iwrite */


int umpi_pack_op_MPI_File_iwrite_at(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iwrite_at(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iwrite_at */


int umpi_pack_op_size_MPI_File_iwrite_at(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iwrite_at */


int umpi_pack_op_MPI_File_read_shared(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_shared(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_shared */


int umpi_pack_op_size_MPI_File_read_shared(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_shared */


int umpi_pack_op_MPI_File_write_shared(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_shared(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_shared */


int umpi_pack_op_size_MPI_File_write_shared(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_shared */


int umpi_pack_op_MPI_File_iread_shared(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iread_shared(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iread_shared */


int umpi_pack_op_size_MPI_File_iread_shared(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iread_shared */


int umpi_pack_op_MPI_File_iwrite_shared(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_iwrite_shared(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_iwrite_shared */


int umpi_pack_op_size_MPI_File_iwrite_shared(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.request);
} /* umpi_pack_op_size_MPI_File_iwrite_shared */


int umpi_pack_op_MPI_File_read_ordered(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_ordered(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_ordered */


int umpi_pack_op_size_MPI_File_read_ordered(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_ordered */


int umpi_pack_op_MPI_File_write_ordered(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_ordered(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_ordered */


int umpi_pack_op_size_MPI_File_write_ordered(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_ordered */


int umpi_pack_op_MPI_File_read_at_all_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_at_all_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_at_all_begin */


int umpi_pack_op_size_MPI_File_read_at_all_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_read_at_all_begin */


int umpi_pack_op_MPI_File_read_at_all_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_at_all_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_at_all_end */


int umpi_pack_op_size_MPI_File_read_at_all_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_at_all_end */


int umpi_pack_op_MPI_File_write_at_all_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_at_all_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_at_all_begin */


int umpi_pack_op_size_MPI_File_write_at_all_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_write_at_all_begin */


int umpi_pack_op_MPI_File_write_at_all_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_at_all_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_at_all_end */


int umpi_pack_op_size_MPI_File_write_at_all_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_at_all_end */


int umpi_pack_op_MPI_File_read_all_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_all_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_all_begin */


int umpi_pack_op_size_MPI_File_read_all_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_read_all_begin */


int umpi_pack_op_MPI_File_write_all_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_all_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_all_begin */


int umpi_pack_op_size_MPI_File_write_all_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_write_all_begin */


int umpi_pack_op_MPI_File_read_all_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_all_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_all_end */


int umpi_pack_op_size_MPI_File_read_all_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_all_end */


int umpi_pack_op_MPI_File_write_all_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_all_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_all_end */


int umpi_pack_op_size_MPI_File_write_all_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_all_end */


int umpi_pack_op_MPI_File_read_ordered_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_ordered_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_ordered_begin */


int umpi_pack_op_size_MPI_File_read_ordered_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_read_ordered_begin */


int umpi_pack_op_MPI_File_read_ordered_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_read_ordered_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_read_ordered_end */


int umpi_pack_op_size_MPI_File_read_ordered_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_read_ordered_end */


int umpi_pack_op_MPI_File_write_ordered_begin(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_ordered_begin(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_ordered_begin */


int umpi_pack_op_size_MPI_File_write_ordered_begin(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.count)+sizeof(op->data.mpi.datatype);
} /* umpi_pack_op_size_MPI_File_write_ordered_begin */


int umpi_pack_op_MPI_File_write_ordered_end(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_write_ordered_end(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_write_ordered_end */


int umpi_pack_op_size_MPI_File_write_ordered_end(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.buf)+sizeof(op->data.mpi.status_src);
} /* umpi_pack_op_size_MPI_File_write_ordered_end */


int umpi_pack_op_MPI_File_get_size(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_size(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_size */


int umpi_pack_op_size_MPI_File_get_size(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.size);
} /* umpi_pack_op_size_MPI_File_get_size */


int umpi_pack_op_MPI_File_get_amode(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_amode(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_amode */


int umpi_pack_op_size_MPI_File_get_amode(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.amode);
} /* umpi_pack_op_size_MPI_File_get_amode */


int umpi_pack_op_MPI_File_get_group(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_group(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_group */


int umpi_pack_op_size_MPI_File_get_group(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.group);
} /* umpi_pack_op_size_MPI_File_get_group */


int umpi_pack_op_MPI_File_get_info(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_info(op);
...
bcopy (&(op->data.mpi.info_used), &buf[index], sizeof(op->data.mpi.info_used));
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_info */


int umpi_pack_op_size_MPI_File_get_info(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.info_used);
} /* umpi_pack_op_size_MPI_File_get_info */


int umpi_pack_op_MPI_File_get_view(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_view(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_view */


int umpi_pack_op_size_MPI_File_get_view(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.disp)+sizeof(op->data.mpi.etype)+sizeof(op->data.mpi.filetype)+sizeof(op->data.mpi.datarep);
} /* umpi_pack_op_size_MPI_File_get_view */


int umpi_pack_op_MPI_File_get_byte_offset(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_byte_offset(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_byte_offset */


int umpi_pack_op_size_MPI_File_get_byte_offset(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset)+sizeof(op->data.mpi.disp);
} /* umpi_pack_op_size_MPI_File_get_byte_offset */


int umpi_pack_op_MPI_File_get_position(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_position(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_position */


int umpi_pack_op_size_MPI_File_get_position(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.offset);
} /* umpi_pack_op_size_MPI_File_get_position */


int umpi_pack_op_MPI_File_get_atomicity(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_get_atomicity(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_get_atomicity */


int umpi_pack_op_size_MPI_File_get_atomicity(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.flag);
} /* umpi_pack_op_size_MPI_File_get_atomicity */


int umpi_pack_op_MPI_File_set_Info(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_set_Info(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_set_Info */


int umpi_pack_op_size_MPI_File_set_Info(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh)+sizeof(op->data.mpi.info);
} /* umpi_pack_op_size_MPI_File_set_Info */


int umpi_pack_op_MPI_File_c2f(umpi_op_t*op,char *buf,int maxlen)
{
unsigned index;
int temp = UMPI_START_PACKED_OP;
int packed_size = umpi_pack_op_size_MPI_File_c2f(op);
...
return UMPIERR_OK;
} /* umpi_pack_op_MPI_File_c2f */


int umpi_pack_op_size_MPI_File_c2f(umpi_op_t*op)
{
return 3*sizeof(int)+sizeof(op->op)+sizeof(op->order)+sizeof(op->rank)+sizeof(op->pc)+sizeof(op->seq_num)+sizeof(op->data.mpi.fh);
} /* umpi_pack_op_size_MPI_File_c2f */
